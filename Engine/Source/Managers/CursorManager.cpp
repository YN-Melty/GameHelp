...
CursorManager::CursorManager(sf::RenderWindow &window) : window_(window),
...
{
    const sf::Vector2f joystickDirection(sf::Joystick::getAxisPosition(0, sf::Joystick::Axis::X) / 100,
